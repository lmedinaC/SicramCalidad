            ...
            <div class="contenido">
                <div class="contenido-perfil ">
                    <div class="perfil-label">
                        <h2>Bienvenido(a) "Nombre del paciente" </h2>
                        <p class="">En SICRAM podrás realizar orientacion médica a personas que tienen alguna
                            discapacidad.
                        </p>
                    </div>
                    ...
                    <div class="row justify-content-around">
                        <div class="col-lg-5 imagen">
                            ...
                            <p class="font-weight-bold parrafo">Doctores de todas las especialidades</p>
                        </div>
                        <div class="col-lg-5  imagen">
