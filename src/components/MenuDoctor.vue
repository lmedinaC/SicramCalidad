                ...
                <li class="">
                   ...
                   <b-collapse id="collapse-1" >         
                    <ul class="list-unstyled" id="PerfilSubmenu">
                        <li>
                            <a href="#" @click="cambiarComponente('PerfilDoctor')">Tu perfil</a>
                        </li>
                        <li>
                            <a href="#"  @click="cambiarComponente('ActualizarDoctor')">Actualizar datos</a>
                        </li>
                    </ul>
                    </b-collapse>
                </li>
                <li class="">
                    <a href="#HorarioSubmenu" v-b-toggle.collapse-2 data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                        <i class="fa fa-clock icono" aria-hidden="true"></i>Horario</a>
                    <b-collapse id="collapse-2" >  
                    <ul class=" list-unstyled" id="citasSubmenu">
                        
                        <li>
                            <a href="#" @click="cambiarComponente('AgregarHorarioDoc')">Agregar horario</a>
                        </li>
                        <li>
                            <a href="#" @click="cambiarComponente('ModificarHorarioDoc')">Modificar horario</a>
                        </li>
                    </ul>
                    </b-collapse>
                </li>
