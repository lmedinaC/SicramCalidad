                            ...
                            <div class="datos-personales ">
                                <div class="row">
                                    <div class="col col-lg-5">
                                        <div class="valores font-weight-bold">
                                            <ul class="text-left">
                                                <li class="text-left">Nombres y apellidos </li>
                                                <li>DNI: </li>
                                                <li>Sexo: </li>
                                                <li>Edad: </li>
                                            </ul>
                                    ...
                                    <div class="col-6 col-lg-5">
                                        <div class="valores font-weight-bold">
                                            <ul>
                                                ...
                                                <li>Registro nacional de especialidad: </li>
                                            </ul>
                                        </div>   
                                    </div>
                                   <div class=" col-6 col-lg-5">
                                        <div class="respuestas respuestas2">
                                            <ul>
                                                <li >:32165312 </li>
                                                <li>:Cardiologo</li>
                                                <li>:no sé</li>
