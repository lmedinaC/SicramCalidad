...
<!-- Page Content  -->
        <div id="content">
            <div class="">
                <button type="button" id="sidebarCollapse" class=" boton-menu mb-0 pb-0">
                    ...
                    <form>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="inputCMP">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputColegiatura">Número de colegiatura</label>
                                <input type="number" class="form-control" id="inputColegiatura">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputRegistro">Registro nacional de especialidad</label>
                                <input type="text" class="form-control" id="inputRegistro">
                            </div>
                        </div>
                        <div class="text-center boton-final">  
                            <button class="  btn btn-dark btn-lg " type="submit">Actualizar</button>
...
.boton-final button:hover{
    background:rgba(19, 101, 107, 0.829); 
}


.boton-final button:focus{
    background:rgba(19, 101, 107, 0.829) !important; 
